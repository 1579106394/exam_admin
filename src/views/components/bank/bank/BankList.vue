<template>
  <div>
        ...
        <el-card :body-style="{ padding: '0px' }" shadow="hover" class="bank-card">
          ...
          <div style="padding: 14px;">
            ...
            <div class="bottom clearfix">
              <el-button type="primary" @click="toUpdate(bank.bankId)" style="margin-left:11%">编辑</el-button>
              <el-button type="danger" @click="toDelete(bank.bankId)">删除</el-button>
            </div>
          </div>
        </el-card>
      </el-col>
    ...
    <el-dialog :title="dialogTitle" :visible.sync="dialogFormVisible" v-loading="loading">
      <el-form :rules="rules" ref="bank" :model="bank" label-width="80px" size="small">
